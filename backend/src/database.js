...
export const addItemInProductTable = async () => {
  db.serialize(() => {
    db.exec(
      `INSERT INTO Product (name, qtd, price) VALUES ('Lapis', 500, 5.25)`
    );
    db.exec(
      `INSERT INTO Product (name, qtd, price) VALUES ('Caneta', 100, 10.25)`
    );
    db.exec(
      `INSERT INTO Product (name, qtd, price) VALUES ('Carro', 50, 49999.99)`
    );
  });
};
